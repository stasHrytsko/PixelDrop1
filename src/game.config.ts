...
export const GAME: GameDefinition = {
  ...
  title: 'Pixel Drop',
  tagline: 'Собери картинку из фигур по образцу',
  version: 2,

  levelCount: 1,

  onboarding: {
    // Bumped for v2 — the rules changed completely, everyone sees them again.
    version: 2,
    title: 'Как играть',
    rules: [
      'Наверху — маленькая картинка-образец, внизу — все фигуры сразу',
      'Перетаскивай фигуру на поле, чтобы собрать точно такую же картинку',
      'Фигуру можно двигать и возвращать вниз сколько угодно раз — штрафа нет',
      'Цвет неважен, если фигура попала не туда, — просто передвинь её',
      'Победа — когда картинка совпала полностью и все фигуры расставлены',
      'Значок на клетке всегда один и тот же для одного цвета — ориентируйся по нему',
    ],
  },
